...
import com.sleepace.p102tsdk.demo.SearchBleDeviceActivity;
...
import com.sleepace.sdk.p102t.P102TDeviceManager.DeviceStateListener;
import com.sleepace.sdk.p102t.domain.BatteryBean;
import com.sleepace.sdk.p102t.domain.DeviceState;
...
//        		mSetting.edit().putString("uid", uid).commit();
	...
	private FirmwareBean getFirmwareBean(){
		...
		try {
			switch(deviceType){
			case DEVICE_TYPE_P102T:
				is = getResources().getAssets().open("P102T-v1.13r(v2.0.1b)-g-20210927.img");
				pKey = "e3d6554a8b26a9950695f53e81a738ae304319d3f8bfac7a9b15f1d7fa4ddf024247dbdff47f233afe41a9b5b3d2c57f18e1a576d2603f8d5fd1133ec4f3de5e";
				hashCode = "1a78b5e87e034f74938469715b0c8a5ad1527315d5800ec5cbc59c3d63200d57";
				break;
			default:
				break;
			}
